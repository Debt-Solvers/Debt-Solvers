...
//        val backEndURL= "http://10.0.2.2:8080/api/v1/user"
        val backEndURL="http://74.235.241.67:30000/api/v1/user"
        if (token != null) {
...
//        val backEndURL="http://10.0.2.2:8080/api/v1/logout"
        val backEndURL="http://74.235.241.67:30000/api/v1/logout"
        if (token != null) {
            val request = Request.Builder()
                .url(backEndURL)
...
//        val backEndURL = "http://10.0.2.2:8080/api/v1/change-password"
        val backEndURL="http://74.235.241.67:30000/api/v1/change-password"
        if (token != null) {
...
//        val backEndURL = "http://10.0.2.2:8080/api/v1/user/update"
        val backEndURL="http://74.235.241.67:30000/api/v1/user/update"
        if (token != null) {
